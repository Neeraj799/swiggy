...
import { useGetRestaurantDetails } from "@/api/SearchRestaurantApi";
import CheckoutButton from "@/components/CheckoutButton";
import type { UserFormData } from "@/components/forms/user-profile-form/UserProfileForm";
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="grid md:grid-cols-[4fr_2fr] gap-5 md:px-32">
        <div className="flex flex-col gap-4">
          ...
          <span className="text-2xl font-bold tracing-tight">Menu</span>
